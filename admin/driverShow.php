...
<div class="w3-sidebar w3-bar-block w3-black w3-card" style="width:250px;">
    ...
    <div style="margin-left: 300px; margin-right: 150px;" class="w3-container">
        <h2><center>Drivers</center></h2><br>
          ...
          <?php
            ...
            if ($result->num_rows > 0) {
              while($row = $result->fetch_assoc()) {
                $count++;
                  echo  "<tr><td> ". $count."</td><td> ". $row["driver_id"]. "</td><td> " . $row["name"] ."</td><td> ".$row["gender"]."</td><td> ".$row["contact_no"]."</td><td> ".$row["license"]."</td><td>".$row["status"]."</td></tr> ";
              }  
           } 
              if($count==0)
              {
