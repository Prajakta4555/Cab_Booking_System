...
<div class="w3-sidebar w3-bar-block w3-black w3-card" style="width:250px;">
    ...
    <div style="margin-left: 300px; margin-right: 150px;" class="w3-container">
        <h2><center>Bookings</center></h2><br>
          ...
          <?php
            ...
            if ($result->num_rows > 0) {
              while($row = $result->fetch_assoc()) {
               ...
               $sql1 = "SELECT * FROM booking_details where customer_id = '$customer_id'";
               ...
               if ($result1->num_rows > 0) {
                while($row = $result1->fetch_assoc()) {
                  ...
                  $sql2 = "SELECT * FROM bill_details where booking_id = '$booking_id'";
